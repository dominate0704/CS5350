function  root  = id3Depth( data, attributes, attributesLive, depth )
len = length(data(:,1));
...
if sum(attributesLive) == 0 || depth == 0
...
if isempty(data_0)
    ...
    % recursive
    root.left0 = id3Depth(data_0, attributes, attributesLive, depth-1);
end
...
if isempty(data_1)
    ...
    % recursive
    root.right1 = id3Depth(data_1, attributes,attributesLive, depth-1);
end
